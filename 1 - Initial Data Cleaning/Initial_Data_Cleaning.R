...
#-------------------------------------------------------------------------------
ECSmithHerbariumAccessions_PhenologyScoring <- read_excel("ECSmithHerbariumAccessions_PhenologyScoring.xlsx", 
                                                          col_types = c("text", "text", "text", 
                                                                        ...
                                                                        "text", "text", "text", "text", "text", 
                                                                        "text"))
#Filter for only vaccinium angustifolium 
ECSmithHerbariumAccessions_PhenologyScoring<- ECSmithHerbariumAccessions_PhenologyScoring %>% 
  filter(`Scientific Name` == "Vaccinium angustifolium")
